...
const workIcon = {
    ...
    iconStyle: { background: 'rgb(33, 150, 243)', color: '#222' },
};
const schoolIcon = {
    icon: <FontAwesomeIcon icon={faSchool} />,
    iconStyle: { background: 'rgb(233, 30, 99)', color: '#222' },
};
const starIcon = {
    icon: <FontAwesomeIcon icon={faStar} />,
    iconStyle: { background: 'rgb(16, 204, 82)', color: '#222' },
};
        ...
        <div >
            ...
            <VerticalTimeline>
                {timeline.map((t, i) => {
                    const contentStyle =
                        i === 0
                            ? { background: 'rgb(33, 150, 243)', color: '#222' }
                            : undefined;
                    const arrowStyle =
                        i === 0
